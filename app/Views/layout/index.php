    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        <li class="nav-item"><a class="nav-link" href="index.html">
            ...
            </svg> Beranda<span class="badge badge-sm bg-info ms-auto">NEW</span></a></li>
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="karyawan"><span class="nav-icon"></span> Daftar Karyawan</a></li>
            <li class="nav-item"><a class="nav-link" href="tambah"><span class="nav-icon"></span> Tambah Karyawan</a></li>
            <li class="nav-item"><a class="nav-link" href="edit"><span class="nav-icon"></span> Edit Karyawan</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item"><a class="nav-link" href="colors.html">
          ...
          <ul class="nav-group-items">
            <li class="nav-item"><a class="nav-link" href="karyawan"><span class="nav-icon"></span> Absen Masuk</a></li>
            <li class="nav-item"><a class="nav-link" href="buttons/button-group.html"><span class="nav-icon"></span> Absen Pulang</a></li>
          </ul>
        </li>
